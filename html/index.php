...
<div class="container">
    ...
    <div class="row min-vh-100 align-items-center text-center text-md-left">
        ...
        <div class="col-md-6 pr-md-5" data-aos="zoom-in">
            <img src="Doctors-amico.svg" width="100%" alt="">
        </div>
...
<div class="container">
    ...
    <div class="row min-vh-100 align-items-center">
        ...
        <div class="col-md-6 d-none d-md-block" data-aos="fade-left">
            <img src="Cardiologist-bro.svg" width="100%" alt="">
        </div>
...
<div class="box-container">
    ...
    <div class="box" data-aos="zoom-in">
        <a href="img1.jpg" title="our team">
            <img src="Doctor-bro.svg" alt="">
        </a>
    </div>
...
<section class="footer">
    ...
    <h1 class="credit text-center mx-auto">created by <span>Think Coders</span> | all rights reserved.</h1>
